...
const investorSchema = new Schema<InvestorInterface>({
  ...
  companyInfo: {
    ...
    investorType: { type: String, enum: ['Strategic', 'Financial'], default: 'Strategic' },
...
const Investor = mongoose.model<InvestorInterface, InvestorModel>('Investor', investorSchema);
