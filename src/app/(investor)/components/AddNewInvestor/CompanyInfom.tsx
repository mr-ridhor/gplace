...
interface Props {
  companyInfo: invcomType;
  setCompanyInfo: React.Dispatch<React.SetStateAction<invcomType>>;
  onNext: () => void;
}
const CompanyInfom: React.FC<Props> = ({
  companyInfo,
  setCompanyInfo,
  onNext,
}) => {
...
//   onNext: () => void;
// }
// const CompanyInfom: React.FC<CompanyInfoProps> = ({
//   companyInfo,
//   setCompanyInfo,
//   onNext,
// }) => {
