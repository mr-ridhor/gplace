...
const Leftbar: React.FC<LeftbarProps> = ({ list }) => {
  ...
  return (
    <div className="md:w-[200px] z-30 fixed w-full hidden md:flex items-start justify-center">
      <div className="space-y-4 w-full rounded-md min-h-[220px] gap-x-1 xl:min-h-[340px] 2xl:min-h-[600px] md:flex flex-col items-start justify-center overflow-y-auto no-scrollbar py-4">
        <div className="bg-[#F5F8FA]  space-y-1.5 py-3 xl:space-y-4 2xl:space-y-10 w-full">
